...
import { TemplateThumbnail, templateFolderOf } from "../../template-studio/TemplateThumbnail";
      ...
      <div className="grid items-start gap-3 lg:grid-cols-2">
        ...
        <section className={`${card} p-5`}>
          ...
          <div className="mt-3 grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
            {templates.slice(0, 9).map((template) => <TemplateCard key={template.id} template={template} onOpen={openTemplate} />)}
